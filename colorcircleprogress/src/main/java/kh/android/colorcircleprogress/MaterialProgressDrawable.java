...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    @IntDef({LARGE, DEFAULT, HUGE})
    @interface ProgressDrawableSize {}

    // Maps to ProgressBar.Large style
    static final int LARGE = 0;
    // Maps to ProgressBar.Huge style
    ...
    // Maps to ProgressBar.Huge style
    private static final int CIRCLE_DIAMETER_HUGE = 80;
    private static final float CENTER_RADIUS_HUGE = 15.5f;
    private static final float STROKE_WIDTH_HUGE = 3f;
    ...
    /** Layout info for the arrowhead for the large spinner in dp */
    private static final int ARROW_WIDTH_HUGE = 14;
    private static final int ARROW_HEIGHT_HUGE = 7;
    private static final float MAX_PROGRESS_HUGE = .10f;
     ...
     *             {@link MaterialProgressDrawable.HUGE}
     */
    public void updateSizes(@ProgressDrawableSize int size) {
        if (size == LARGE) {
            ...
            setSizeParameters(CIRCLE_DIAMETER_HUGE, CIRCLE_DIAMETER_HUGE, CENTER_RADIUS_HUGE, STROKE_WIDTH_HUGE,
                    ARROW_WIDTH_HUGE, ARROW_HEIGHT_HUGE);
        }
    }
